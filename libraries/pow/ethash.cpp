...
using celesos::ethash::FNV_PRIME;
using celesos::ethash::NODE_BYTES;
using celesos::ethash::NODE_WORDS;
using celesos::ethash::MIX_BYTES;
using celesos::ethash::MIX_WORDS;
using celesos::ethash::MIX_NODES;
using celesos::ethash::ACCESSES;
using celesos::ethash::DATASET_PARENTS;
using celesos::ethash::CACHE_ROUNDS;
...
bool celesos::ethash::calc_cache(vector<node> &cache, uint32_t cache_count, const string &seed) {
...
bool celesos::ethash::calc_dataset(vector<node> &dataset, uint32_t dataset_count, const vector<node> &cache) {
...
uint256_t
celesos::ethash::hash_light(const string &forest, uint64_t nonce, uint32_t dataset_count,
...
uint256_t
celesos::ethash::hash_full(const string &forest, uint64_t nonce, uint32_t dataset_count,
